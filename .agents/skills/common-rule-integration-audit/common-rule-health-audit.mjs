...
const CONTRACTS = Object.freeze([
  ...
  {id:'ui-reference-authority',required:'TECHNICAL',docs:['AGENTS.md','OPERATIONS.md','.agents/skills/handoff/SKILL.md'],impl:['.agents/skills/handoff/ui-reference-registry.mjs','.agents/skills/handoff/ui-reference-manager.mjs','.agents/skills/handoff/canonical-contract-gate.mjs'],tests:['.agents/skills/handoff/ui-reference-manager-selftest.mjs','.agents/skills/handoff/canonical-contract-gate-selftest.mjs'],activationMode:'CANONICAL_CONTRACT_TURN_START_PREFLIGHT_FINAL_AUDIT',enforcementScope:'LOCAL_WHEN_INVOKED_PLUS_PORTFOLIO_AUDIT',activationEvidence:[{path:'.agents/skills/handoff/canonical-contract-gate.mjs',contains:'verifyUiReferenceSources'},{path:'.agents/skills/handoff/SKILL.md',contains:'ui-reference-manager.mjs'},{path:'tools/portfolio-governance-audit.mjs',contains:'uiReferenceCurrent'}]},
  ...
  {id:'staged-reality-checks',required:'TECHNICAL',docs:['AGENTS.md','OPERATIONS.md','.agents/skills/test-gate/SKILL.md','.agents/skills/final-pr-audit/SKILL.md'],impl:['.agents/skills/test-gate/staged-reality-gate.mjs'],tests:['.agents/skills/test-gate/staged-reality-gate-selftest.mjs'],activationMode:'EARLY_MILESTONE_FINAL_REALITY_WITH_FINAL_AUDIT_RECEIVER',enforcementScope:'LOCAL_WHEN_INVOKED_PLUS_FINAL_AUDIT_PLUS_PORTFOLIO_AUDIT',activationEvidence:[{path:'AGENTS.md',contains:'STAGED_REALITY_GATE_REQUIRED=YES'},{path:'.agents/skills/test-gate/SKILL.md',contains:'STAGED_REALITY_GATE_REQUIRED=YES'},{path:'.agents/skills/final-pr-audit/SKILL.md',contains:'FINAL_REALITY_CHECK_REQUIRED=YES'},{path:'tools/portfolio-governance-audit.mjs',contains:'stagedRealityCurrent'}]},
  {id:'executable-implementation-routing',required:'TECHNICAL',docs:['.agents/skills/preflight-audit/SKILL.md','.agents/skills/final-pr-audit/SKILL.md','learnings/L-0006.md'],impl:['.agents/skills/preflight-audit/implementation-runner.mjs','.agents/skills/preflight-audit/implementation-route-receipt.mjs','.agents/skills/preflight-audit/implementation-orchestrator.mjs'],tests:['.agents/skills/preflight-audit/implementation-runner-selftest.mjs','.agents/skills/preflight-audit/implementation-route-receipt-selftest.mjs','.agents/skills/preflight-audit/implementation-orchestrator-selftest.mjs'],activationMode:'FINAL_PR_AUDIT_QUALIFIED_AGENT_RECEIPT_VERIFICATION',enforcementScope:'LOCAL_WHEN_INVOKED_PLUS_FINAL_AUDIT',activationEvidence:[{path:'.agents/skills/preflight-audit/implementation-route-receipt.mjs',contains:'verifyFinalReceipt'},{path:'.agents/skills/final-pr-audit/SKILL.md',contains:'IMPLEMENTATION_ROUTE_RECEIPT_REQUIRED=YES'}]},
]);
